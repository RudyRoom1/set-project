...
```
cd existing_repo
git remote add origin https://git.epam.com/yaroslav_kush/set-program.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.epam.com/yaroslav_kush/set-program/-/settings/integrations)
